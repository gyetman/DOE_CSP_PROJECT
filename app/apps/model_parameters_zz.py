...
def create_tabs_and_tables(x, samjson):
    ...
    return [_make_tabs_in_collapse(m) for m in models] #+ [SAM_JSON_file]
    ...
    if n_clicks:
        ...
        for solTable in solTableData:
            for sRow in solTable:
                ...
                if samjson:
                    try:
                        solar_output_vars[sRow['Name']] = imported_json[sRow['Name']]
                    except:
        ...
        for finTable in finTableData:
            for fRow in finTable:
                ...
                if samjson:
                    try:
                        finance_output_vars[fRow['Name']] = imported_json[fRow['Name']]
                    except:
