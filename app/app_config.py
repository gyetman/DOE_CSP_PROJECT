...
solarToDesal = {
    'pvsamv1' : [('FO',True),('VAGMD',True),('LTMED',True),('ABS',True),('MEDTVC',True),('MBD',True),('NUN',True),('RO',False)],
    'SC_FPC' : [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'SC_ETC' : [('FO',True),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'trough_physical_process_heat': [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'linear_fresnel_dsg_iph': [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcsiscc': [('FO',True),('VAGMD',True),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcslinear_fresnel': [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcsMSLF': [('FO',True),('VAGMD',True),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcsdirect_steam': [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcsmolten_salt': [('FO',True),('VAGMD',True),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'tcstrough_physical'  : [('FO',False),('VAGMD',False),('LTMED',False),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',True)],
    'none'  : [('FO',True),('VAGMD',True),('LTMED',True),('ABS',True),('MEDTVC',False),('MBD',True),('NUN',True),('RO',False)],
    }
