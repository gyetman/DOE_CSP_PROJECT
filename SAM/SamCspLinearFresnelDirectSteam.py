...
class samCspLinearFresnelDirectSteam:
	...
	path_dpf=os.path.dirname(os.path.realpath(__file__)) + '/AssociatedFiles/dispatch_factors_ts.csv'
	path_solarresource=os.path.dirname(os.path.realpath(__file__)) + '/solar_resource/'
	ssc.data_set_string( data, b'file_name', b''+path_solarresource.encode("ascii", "backslashreplace")+ ('United Arab Emirates ARE Abu_Dhabi (INTL).csv').encode("ascii", "backslashreplace") );
	...
	ssc.data_set_array_from_csv( data, b'dispatch_factors_ts', b''+path_dpf.encode("ascii", "backslashreplace"));
