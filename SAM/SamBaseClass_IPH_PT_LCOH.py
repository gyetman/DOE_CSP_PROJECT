...
class SamBaseClass(object):
    ...
    def main(self):
        ...
        self.cspModel = "TroughPhysicalProcessHeat"
        ...
        self.module_create_execute('trough_physical_process_heat')
        ...
        self.module_create_execute('iph_to_lcoefcr')
    ...
    def collect_model_variables(self):
        ...
        json_files = []
        cspPath = 'TroughPhysicalProcessHeat_inputs.json'
        finPath = 'iph_to_lcoefcr_inputs.json'
        fin2Path = 'lcoefcr_IPH_PT_inputs.json'
        ...
        cspValues = "TroughPhysicalProcessHeat_PhysicalTroughIPHLCOHCalculator.json"
        finValues = "IphToLcoefcr_PhysicalTroughIPHLCOHCalculator.json"
        fin2Values = "Lcoefcr_PhysicalTroughIPHLCOHCalculator.json"
        json_values = []
